...
GO
	DECLARE	@partition_number	INT = $PARTITION.pf_o_orderdate('2014-01-01');
	...
	*/
	ALTER PARTITION FUNCTION pf_o_orderdate() MERGE RANGE ('2014-01-01');
...
*/
ALTER DATABASE [ERP_Demo] REMOVE FILE [orders_2014];
ALTER DATABASE [ERP_Demo] REMOVE FILEGROUP [orders_2014];
GO
